...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private ImageView mCustomBitmap;
...
//                    mButtonsContainer.setVisibility(View.GONE);
    ...
    public SweetAlertDialog setCustomBitmap(Bitmap bitmap) {
        mBitmap = bitmap;
        if (mCustomBitmap != null && mBitmap != null) {
            mCustomBitmap.setVisibility(View.VISIBLE);
            mCustomBitmap.setImageBitmap(mBitmap);
        }
        return this;
    }
